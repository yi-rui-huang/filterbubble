<template>
  <div class="entry-container">
    <div class="card entry-card">
      <h2 class="card-title">Thank you for participating in our research study on movie recommendations generated by ChatGPT.</h2>
      <p class="entry-description">
        This study is designed to evaluate your experience with ChatGPT-generated movie recommendations, focusing on both the quality of the recommendations and the diversity of the content.<br><br>
